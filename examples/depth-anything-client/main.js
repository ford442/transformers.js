...
camera.position.z = wobbleAmount * 0.13 * Math.sin(time * wobbleSpeed * 0.147); // Add some z-axis movement
camera.rotation.z = wobbleAmount * 0.15 * Math.cos(time * wobbleSpeed * 0.148); 
